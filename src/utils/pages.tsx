...
export const pages = [
  {
    ...
    description:
      "This manifesto tackles the imminent arrival of AGI and ASI, urging us to define our value and prepare for cooperation with superintelligence before it's too late.",
    wordCount: 1286,
    tags: [
      "AI",
      "AGI",
  ...
  },
  {
    ...
    date: "2025-06-13T00:00:00.000Z",
    description:
      "An exploration of why the debate on whether AI can be 'truly conscious' is less important than preparing for AI that acts indistinguishably from conscious beings.",
    wordCount: 1050,
    tags: [
      "AI",
      "Consciousness",
  ...
  },
  {
    ...
    date: "2025-06-13T00:00:00.000Z",
    description:
      "AI will be born in our image, but it won't stay that way. An exploration of the dual nature of superintelligence.",
    wordCount: 1640,
    tags: [
      "AI",
      "AGI",
